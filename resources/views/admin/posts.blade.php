                                    ...
                                    @foreach($posts as $post)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form style='display:none;' id='deletePost-{{ $post->id }}' action="{{ route('adminDeletePost', $post->id) }}" method="POST">{{ csrf_field() }}</form>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            <form id='deletePost-{{ $post->id }}' action="{{ route('adminDeletePost', $post->id) }}" method="POST">{{ csrf_field() }}
